// ============================================================================
//  连字符规则表（hyph_en_US.dic，UTF-8，LPPL 许可）
// ============================================================================
//  这是 TeX / LibreOffice / 浏览器 CSS 断词 共用的"事实标准"词库，由 pyphen
//  包原样导出。本文件【只含数据、不含任何逻辑】——升级词库只需替换这一段，
//  算法代码一行都不用动。
//
//  之所以单独成文件：它有一万多行，和"算法"混在一起会让代码难以维护。
//  现在算法在 liang_algorithm.dart，数据在这里，各司其职。

const String hyphEnUsDic = r'''UTF-8
LEFTHYPHENMIN 2
RIGHTHYPHENMIN 3
...
.parafluorotolu3en
.parafluorotolu4ene
.pa8r8a9ﬂ8u8o8r8o9t8o8l8u8e8n8e.
.para2ﬂ2
.paraﬂu3o
.paraﬂuo3r
.paraﬂuoro1to
...
.pseudodifferenti2al
.ps8e8u9d8o9d8i8ﬀ8e8r9e8n9t8i8a8l.
.pseudod1i4ﬀ
.pseudodiﬀer1
.pseudodiﬀer3en1t
.pseudodiﬀerent2i
